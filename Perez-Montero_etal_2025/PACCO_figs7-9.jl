...
axislegend(ax, framevisible=false, position=(:center, :center), labelsize=25, nbanks=2)
...
Colorbar(fig[0, 2], width=Relative(2/3), height=Relative(1 / 4), colormap=colormap,
...
hidedecorations!(ax)
hidespines!(ax)
lines!(ax, bintanja2008_T[1, :] ./ 1e3, bintanja2008_T[2, :] .* NaN, linewidth=3, color=bintanja2008color, label=L"Bintanja and van de Wal (2008)$\,$")
lines!(ax, luthi2008_co2[1, :] ./ 1e3, luthi2008_co2[2, :] .* NaN, linewidth=3, color=luthi2008color, label=L"Lüthi et al. (2008)$\,$")
lines!(ax, barker2011_temp[1, :] ./ 1e3, barker2011_temp[2, :] .* NaN, linewidth=3, color=barker2011color, label=L"Barker et al. (2011)$\,$")
lines!(ax, df["time"] ./ 1e3, df["T"] .- df["Tref"] .* NaN, color=pacco_color, linewidth=0.0, label="")
lines!(ax, berends2021_co2[1, :] ./ 1e3, berends2021_co2[2, :] .* NaN, linewidth=3, color=berends2021color, label=L"Berends et al. (2021b)$\,$")
lines!(ax, yamamoto2022_co2[1, :] ./ 1e3, yamamoto2022_co2[2, :] .* NaN, linewidth=3, color=yamamoto2022color, label=L"Yamamoto et al. (2022)$\,$")
lines!(ax, spratt2016_vol[1, :] ./ 1e3, spratt2016_vol[2, :] .* NaN, linewidth=3, color=spratt2016color, label=L"Spratt and Lisiecki (2016)$\,$")
lines!(ax, df["time"] ./ 1e3, df["T"] .- df["Tref"] .* NaN, color=pacco_color, linewidth=linewidth, label=L"This study $\,$")

axislegend(ax, framevisible=false, position=(:center, :center), labelsize=25, nbanks=4)
...
hidexdecorations!(ax)
hidespines!(ax, :b, :t)
text!(ax, -792, 3, text=c_label, align=(:left, :center))
hlines!(ax, [0.0], color=background_color, linestyle=:solid)
...
text!(ax, -792, 310, text=e_label, align=(:left, :center))
...
hidespines!(ax, :b, :t)
hlines!(ax, [0.0], color=background_color, linestyle=:solid)
text!(ax, -792, 2200, text=g_label, align=(:left, :center))
...
hidespines!(ax, :t)
hlines!(ax, [0.0], color=background_color, linestyle=:solid)
text!(ax, -792, 10, text=i_label, align=(:left, :center))
